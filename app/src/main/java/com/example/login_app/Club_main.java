...
public class Club_main extends AppCompatActivity {
    ...
    {
        Intent intent=new Intent(this, Photography_interface.class);
        startActivity(intent);
    }

    public void openEchoclub_interface()
    {
        Intent intent=new Intent(this, Echo_club_interface.class);
        startActivity(intent);
    }
    public void openChessclub_interface()
    {
        Intent intent=new Intent(this, Chess_club_interface .class);
        startActivity(intent);
    }
    public void openDancingclub_interface()
    {
        Intent intent=new Intent(this, Dancing_club_interface.class);
        startActivity(intent);
    }
    public void openTMclub_interface()
    {
        Intent intent=new Intent(this, Toastmasters_club_interface.class);
        startActivity(intent);
    }
    public void openEclub_interface()
    {
        Intent intent=new Intent(this, E_club_interface.class);
        startActivity(intent);
    }
    public void openARclub_interface()
    {
        Intent intent=new Intent(this, AR_club_interface.class);
        startActivity(intent);
    }
    public void openBridgeclub_interface()
    {
        Intent intent=new Intent(this, Bridge_club_interface.class);
        startActivity(intent);
    }
    public void openRowingclub_interface()
    {
        Intent intent=new Intent(this, Rowing_club_interface.class);
        startActivity(intent);
    }
    public void openRotaractclub_interface()
    {
        Intent intent=new Intent(this,Rotaract_club_interface.class);
        startActivity(intent);
    }
    public void openScoutclub_interface()
    {
        Intent intent=new Intent(this,RoverScout_club_interface.class);
        startActivity(intent);
    }
}